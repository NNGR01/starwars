          ...
          <div className="card" >
            ...
            <div className="card-body ">
              ...
              <p className="card-text text-center">
               ...
               <p className="card-text text-center"> <Link to={`/naves/${item.uid}`}><button className="btn btn-outline-success mx-3 text-center" type="button">Ficha tecnica</button></Link></p>
            </div>
            </div>
          </div>
    )
